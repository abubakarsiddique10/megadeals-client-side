    ...
    return (
        <nav className="py-4 bg-[#2D3054] text-white relative">
            <div className="container flex justify-between items-center">
                ...
                <ul className={`lg:flex lg:static lg:w-auto lg:p-0 p-8 absolute top-[100%] font-medium text-lg gap-5 w-56 bg-[#2D3054] lg:transition-none transition-all duration-500 ease-in ${open ? 'right-[0]' : 'right-[-230px]'}`}>
                    <li><a href="">Home</a></li>
                    <li><a href="">Shop</a></li>
