                ...
                <div className="product-info border w-[780px] p-8">
                    ...
                    <div className="mt-4 flex items-center gap-4">
                        <div>
                            ...
                            <input type="text" class="border ml-2 w-14 h-10 rounded-lg text-center" value="1" />
                        </div>
                        <button className="bg-[#2d3054] text-white py-2.5 px-8  font-medium rounded-full">Add to Cart</button>
